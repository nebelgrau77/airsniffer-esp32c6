...
ENS160 switches to idling after every measurement cycle. This way if the two sensors are in a common enclosure, its heating element does not affect the BME280 readings too much.
